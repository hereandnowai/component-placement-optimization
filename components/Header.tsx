...
import { ORGANIZATION_DETAILS, PRIMARY_COLOR, SECONDARY_COLOR } from '../constants';
  ...
  return (
    ...
    >
      <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center">
        <div className="flex items-center space-x-3 mb-2 sm:mb-0">
          ...
          <div>
            ...
            <p className="text-sm">{t(ORGANIZATION_DETAILS.shortNameKey)} - {t(ORGANIZATION_DETAILS.sloganKey)}</p>
          </div>
        </div>
        <div className="flex items-center space-x-2 sm:space-x-4">
          <div className="text-right hidden sm:block">
            <p className="text-sm font-medium">{t(ORGANIZATION_DETAILS.fullNameKey)}</p>
          </div>
      ...
      <div className="text-center mt-2 sm:hidden">
         <p className="text-xs font-medium">{t(ORGANIZATION_DETAILS.fullNameKey)}</p>
      </div>
    </header>
  );
};